...
export default function FeaturedMeal({ curr }) {
  return (
    <div className="bg-white rounded-xl min-w-[250px] w-[250px] h-[350px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] mb-6 hover:shadow-lg  transition-all duration-500 ease-in-out p-4 overflow-hidden group">
      {/* Image container */}
      ...
      <div className="h-[20%] flex justify-center items-center">
        <p className="font-[500] text-rich-red-primary transition-colors duration-500">
          {curr.name}
        </p>
      </div>
    </div>
