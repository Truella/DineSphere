...
const mealCategories = [
  {
    ...
    name: "Popular",
    meals: [
      { id: 101, name: "Jollof Rice", img: "/images/GrilledChicken.jpg", alt: "Jollof Rice with grilled chicken" },
      ...
      { id: 105, name: "Fried Rice & Chicken", img: "/images/GrilledChicken.jpg", alt: "Fried rice served with grilled chicken" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    name: "Nigerian",
    meals: [
      { id: 301, name: "Amala & Ewedu", img: "/images/GrilledChicken.jpg", alt: "Amala served with ewedu and stew" },
      ...
      { id: 304, name: "Okro Soup", img: "/images/GrilledChicken.jpg", alt: "Okro soup with assorted meat" },
  ...
  },
  {
    ...
    meals: [
      ...
      { id: 603, name: "Butter Chicken", img: "/images/GrilledChicken.jpg", alt: "Creamy butter chicken curry" },
      { id: 604, name: "Tacos", img: "/images/tacos.jpg", alt: "Assorted tacos with fillings" },
      { id: 605, name: "Sushi Rolls", img: "/images/GrilledChicken.jpg", alt: "Plate of assorted sushi rolls" },
    ],
  },
];
...
export default function QuickPicks() {
  ...
  return (
    <section className="w-[90vw] md:w-[80vw] mx-auto mt-12">
      ...
      <p className="text-center text-sm font-semibold">Explore. Discover. Devour.</p>
